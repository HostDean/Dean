...
public class Reminders {
	...
	private static final String[][] MESSAGE_DATA = { 
			...
			{"@blu@[Server]@bla@ Dont forget to set a bank pin, open the bank to set one!"},
			{"@blu@[Server]@bla@ Type ::find (item name) to search for an item ID + type ::item (id) to spawn!"},
